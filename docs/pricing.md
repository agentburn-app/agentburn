...
The pricing system is the part of AgentBurn that must never be wrong. Three
rules govern it:
...
AgentBurn says $3.42, one click shows why.

## How prices get in (the hard part)

Provider prices change constantly and rarely expose a clean API. AgentBurn
uses a tiered model:
