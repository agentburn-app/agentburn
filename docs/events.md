...
Every AI action AgentBurn records is one **usage event**. This document is
...
You do **not** send a cost. AgentBurn resolves the pricing version in effect
...
AgentBurn records **metadata, not prompts or completions**. Prompt/completion
